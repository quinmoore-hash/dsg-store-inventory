...
- Kotlin + Spring Boot 2.7.18
- Thymeleaf server-side templates
- Spring Security 5 (form login, `WebSecurityConfigurerAdapter`)
- H2 in-memory database (seeded with 20 products)
- Gradle Kotlin DSL, Java 11 target
...
src/main/kotlin/com/dsg/inventory/
  ...
  SecurityConfig.kt     — Security setup (WebSecurityConfigurerAdapter)
